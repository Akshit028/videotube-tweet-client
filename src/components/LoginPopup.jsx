...
const LoginPopup = ({ onClose, loginTo }) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-[#003554] bg-opacity-75 z-50">
      <div className="bg-[#003554] border border-[#212121] rounded-lg p-8 text-white w-full max-w-md relative">
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col gap-4 items-center mb-6">
          <Logo className="text-3xl font-bold text-[#212121]" />
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-400">
            ...
            <a href="/signup" className="text-[#212121] hover:text-[#212121]">
              Sign up
            </a>
          </p>
        </div>
