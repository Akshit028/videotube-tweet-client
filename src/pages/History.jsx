      ...
      <aside className="w-full sm:w-1/4 p-4 ">
        <div className="relative mb-4">
          <input
            ...
            className="w-full bg-gray-800 text-white border border-[#212121] rounded-md py-2 px-4 pl-10 focus:outline-none focus:ring-2 focus:ring-[#212121]"
          />
          <BiSearch className="absolute h-6 w-6 left-3 top-2.5 text-[#212121]" />
        </div>

        <button
          onClick={clearWatchHistory}
          className="w-full bg-[#212121] hover:bg-[#212121] text-white font-bold py-2 px-4 rounded transition duration-300" 
        >
          Clear Watch History
        </button>
      </aside>
